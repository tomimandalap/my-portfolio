$(document).ready(function () {
  ...
  function lamp() {
    ...
    grd.addColorStop(0.0, "rgba(60, 60, 60, 1.000)");
    ...
    grdOuterHigh.addColorStop(0.0, "rgba(65, 65, 65, 1.000)");
    ...
    grdOuterLow.addColorStop(0.0, "rgba(45, 45, 45, 1.000)");
    ...
    var grdGlow = ctx.createRadialGradient(
      250,
      200,
      0,
      247 + sinGlowMod,
  ...
  function rain() {
    for (var i = 0; i < 500; i++) {
      ...
      grd.addColorStop(0.0, "rgba(100, 170, 160, 0.2)");
  ...
  function sidewalk() {
    ...
    var grd = ctx.createRadialGradient(250, 500, 0, 250, 500, 150);
    ...
    grd = ctx.createRadialGradient(250, 500, 0, 250, 500, 150);
